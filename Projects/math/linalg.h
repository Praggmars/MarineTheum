...
namespace mth
{
	...
	public:
		...
		bool isNear(float2 v, float eps = EPS);
	...
	public:
		...
		bool isNear(float3 v, float eps = EPS);
		float operator()(const int i) const;
		float& operator()(const int i);
	...
	public:
		...
		bool isNear(float4 v, float eps = EPS);
		float operator()(const int i) const;
		float& operator()(const int i);
		explicit operator float2() const;
		explicit operator float3() const;
	...
	public:
		...
		bool isNear(quaternion q, float eps = EPS);
		float operator()(const int i) const;
		float& operator()(const int i);
		explicit operator float*() const;
	};
	...
	public:
		...
		bool isNear(float2x2 m, float eps = EPS);
	};
	...
	public:
		...
		bool isNear(float3x3 m, float eps = EPS);
	};
	...
	public:
		...
		bool isNear(float4x4 m, float eps = EPS);
	};
	...
	std::ostream& operator<<(std::ostream& os, float2x2 m);
	std::ostream& operator<<(std::ostream& os, float3x3 m);
